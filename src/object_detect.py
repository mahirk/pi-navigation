...
def run(screen):
    ...
    if distanceFeet < 0.7:
        ...
        write_and_print("STOP: There is a {} less than 1 foot away, please turn to continue navigation.".format(object_name if object_name is not "" else "object"))
...
while True:
    isButtonPressed = my_button.is_button_pressed() is True
    try:
        _, screen = cap.read()
    ...
    cv2.imshow("Navigation View", run(screen, isButtonPressed))
